...
public class CurrencyConveter {
	...
	public CurrencyConveter(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity,
			BigDecimal totalCalculatedAmount, String envoirnmnent) {
		super();
		this.id = id;
		this.from = from;
		this.to = to;
